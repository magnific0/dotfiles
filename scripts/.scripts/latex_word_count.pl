...
sub License {
  print "# Copyright 2002, 2007, 2009 \251 by Min-Yen Kan; modified by Sam Tygier, 2007; by Gregor Heinrich, 2008; by Martin Magnusson, 2009; by Edward Vigmond, 2009\n";
}
...
#####################################################################
### Prints wordcount - STDERR to make it comaptible with TexMaker ###
#####################################################################
